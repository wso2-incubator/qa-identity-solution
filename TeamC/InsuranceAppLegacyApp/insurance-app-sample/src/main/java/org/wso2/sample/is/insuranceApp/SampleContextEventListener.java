 ...
 * under the License.
 */
package org.wso2.sample.is.insuranceApp;
...
public class SampleContextEventListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent servletContextEvent) {
        ...
        try {
            if(servletContextEvent.getServletContext().getContextPath().contains("insurance.com")) {
                properties.load(servletContextEvent.getServletContext().
                        getResourceAsStream("/WEB-INF/classes/insurance.properties"));
            }
